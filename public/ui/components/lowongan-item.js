    ...
    <div class="row gy-4 gy-lg-0 justify-content-lg-between align-items-lg-center">
        <div class="col col-12 col-lg-auto order-lg-1">
            ...
            <p class="small opacity-50">
                Level : Staff
                <br>
                Berlaku Hingga : 24 September 2023
            </p>
        </div>
                ...
                <div class="py-lg-4">
                    <div class="mb-4">
                        ...
                        <ul class="list-group list-group-bullet">
                            ...
                            <li>Memberikan pelayanan yang terbaik kepada pelanggan, baik yang datang maupun melalui telepon</li>
        ...
        <div class="col col-12 col-lg-4 order-lg-2">
            <div class="d-flex flex-column gap-2 flex-md-row">
                <button class="btn border w-100 border-dark collapsed rounded-0 w-lg-50" data-bs-toggle="collapse" data-bs-target="#kualifikasi1">Kualifikasi</button>
                <a class="btn border w-100 border-dark rounded-0 w-lg-50" href="career_form1.html">Lamar</a>
            </div>
        </div>
    </div>
</li>
