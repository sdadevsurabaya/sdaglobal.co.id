<ul class="list-unstyled text-capitalize d-flex flex-column row-gap-2">
    ...
    <li><a href="{{route('landing')}}#home-products" class="nav-home">products</a></li>
    <li><a href="{{route('about')}}" class="nav-about">about SDA</a></li>
    <li><a href="{{route('industries')}}" class="nav-industries">industries</a></li>
    <li><a href="{{route('landing')}}" class="nav-buy opacity-50" style="pointer-events: none;">where to buy</a></li>
    <li><a href="{{route('contact')}}" class="nav-contact">contact us</a></li>
</ul>
