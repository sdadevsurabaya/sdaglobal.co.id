...
<section>
    <div class="container py-5">
        <div id="en" class="tab-content translations-content-item">
            <h5 class="fs-2"><b>Privacy Policy</b></h5>
            <p class="fs-sm">Last updated: February 23, 2022</p>
            <p class="mt-4">
            ...
            <ul>
                ...
                <li>
                    <strong>Website</strong> refers to SDA, accessible from <a class="text-break" href="sdaglobal.co.id"
                        rel="external nofollow noopener" target="_blank">sdaglobal.co.id</a>
                </li>
                <li>
            ...
            <ul>
                ...
                <li>
                    ...
                    change
                    the settings for disabling, or deleting local shared objects.
                </li>
                <li>
            ...
            <p>
                ...
                required to
                do so by law or in response to valid requests by public authorities (e.g. a court or a
                government
                agency).
            </p>
            <h5 class="fs-5 mt-4">
