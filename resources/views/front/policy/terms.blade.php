        ...
        <div class="tab-content translations-content-item en visible" id="en">
            ...
            <ul>
                ...
                <li>
                    ...
                    Agreement) refers to PT. Sumber Daya Abadi, Komp. Margomulyo Indah I Blok A No. 7-8, Jl.
                    Margomulyo
                    Indah I, Balongsari - Tandes, Surabaya 60186, Jawa Timur - Indonesia.
                </li>
                <li>
                ...
                <li>
                    <strong>Website</strong> refers to SDA, accessible from <a class="text-break"
                        href="www.sdaglobal.co.id" rel="external nofollow noopener"
                        target="_blank">www.sdaglobal.co.id</a>
            ...
            <h5 class="fs-3 mt-5">
                <b>Trademarks, Service Mark, Copyrights and Other Intellectual Property Rights</b>
            </h5>
            <p>
                The entire content included in this Site, including but not limited to copyright and/or another
                intellectual property right in every logo, picture, design, icon, text, voice, software,
                graphic, data
                or another material provided in this website is owned by Company and/or their affiliation and/or
                their
                subsidiary and/or the licensor. COPYRIGHT IS PROTECTED.
            </p>
            <p>
                Mark is all the trade mark and/or the service mark both listed in Website or not listed in
                Website
                which are registered or in the process of registration in the name of Company or another
                trademark
                owner who has given the right of use and/or the license legally to the Company.
            </p>
            <h5 class="fs-3 mt-5">
            ...
            <p>
                ...
                alleged
                to be caused by or in connection with the use of or reliance on any such content, goods or
                services
            ...
            <p>
                ...
                limitations may
                not apply to You. But in such a case the exclusions and limitations set forth in this section
                shall be
...
@endsection
@section('pageScripts')@endsection
